...
## Improvement
OpenAthena can accept DEM GeoTIFF files of higher resolution or accuracy than the SRTM dataset, if provided by the user. Such dataset geoTIFF files must be of similar format to that of the SRTM dataset to avoid undefined program behavior. Newer synthetic aperature radar datasets and LIDAR datasests are [available](https://www.intelligence-airbusds.com/en/8703-worlddem) to those with significant resources
